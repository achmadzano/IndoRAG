...
class RAG:
    ...
    def __init__(self,
        ...
        self.qa_prompt_tmpl_str = (
            "Informasi konteks terdapat di bawah ini.\n"
            "---------------------\n"
            "{context}\n"
            "---------------------\n"
            "Dengan hanya menggunakan informasi dari konteks di atas, Jawab dengan informasi yang sesuai dengan pertanyaan.\n"
            "Jika informasi tidak tersedia dalam konteks, balas dengan 'Saya tidak tahu!'.\n"
            "Pertanyaan: {query}\n"
            "Jawaban: "
        )
